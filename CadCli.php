                                ...
                                <form>
                                    <div class="row g-3 align-items-center">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" placeholder="CPNJ/CPF" class="form-control">
                                            </div>
                                    ...
                                    <div class="row g-3 align-items-center"><br>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label>Bairro</label>
                                            <input type="email" placeholder="Bairro" class="form-control">
                                        </div>
                                    ...
                                    <div class="row g-3 align-items-center"><br>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" placeholder="Data de Criação" class="form-control">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label>Endereço</label>
